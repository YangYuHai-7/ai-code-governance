...
本注册表只描述技术栈与平台能力。OpenSpec 等规格或执行系统属于外部工作流 provider，使用独立的 [工作流集成协议](workflow-integrations.md) 与 [工作流集成注册表](../../../assets/registries/workflow-integration-registry.json)，避免把“项目用什么技术”与“项目怎样组织变更和执行”混成同一决策。
