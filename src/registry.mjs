...
export function loadAgentRegistry() {
  const registry = readJson(path.join(PACKAGE_ROOT, 'assets/agent-registry.json'));
...
export function loadCapabilityRegistry() {
  const registry = readJson(path.join(PACKAGE_ROOT, 'assets/capability-pack-registry.json'));
