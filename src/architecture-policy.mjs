...
import { classifyProject, isImplementationSourcePath, projectSourcePaths } from './project-assessment.mjs';
...
function registry() {
  const value = readJson(path.join(PACKAGE_ROOT, 'assets/architecture-profile-registry.json'));
