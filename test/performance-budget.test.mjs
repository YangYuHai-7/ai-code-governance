...
test('fast full and performance entrypoints preserve the full npm test contract', () => {
  ...
  for (const file of ['args', 'onboarding-product-flow', 'sync-prune', 'sync-retention', 'context-budget', 'artifact-selection', 'task-routing', 'execution-plan', 'generation', 'technical-standards', 'architecture-boundaries']) {
